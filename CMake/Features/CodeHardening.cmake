...
function(add_global_code_hardening)
  ...
  list(JOIN CODE_HARDENING_COMPILE_OPTIONS " " CODE_HARDENING_COMPILE_OPTIONS_STR)
  list(JOIN CODE_HARDENING_LINK_OPTIONS " " CODE_HARDENING_LINK_OPTIONS_STR)
  list(JOIN CODE_HARDENING_CXX_DEFINITIONS " " CODE_HARDENING_CXX_DEFINITIONS_STR)

  string(APPEND CMAKE_CXX_FLAGS " ${CODE_HARDENING_COMPILE_OPTIONS_STR}")
  string(APPEND CMAKE_CXX_FLAGS " ${CODE_HARDENING_CXX_DEFINITIONS_STR}")
  string(APPEND CMAKE_C_FLAGS " ${CODE_HARDENING_COMPILE_OPTIONS_STR}")
  string(APPEND CMAKE_C_FLAGS " ${CODE_HARDENING_CXX_DEFINITIONS_STR}")

  string(APPEND CMAKE_EXE_LINKER_FLAGS " ${CODE_HARDENING_LINK_OPTIONS_STR}")
  string(APPEND CMAKE_SHARED_LINKER_FLAGS " ${CODE_HARDENING_LINK_OPTIONS_STR}")
  string(APPEND CMAKE_MODULE_LINKER_FLAGS " ${CODE_HARDENING_LINK_OPTIONS_STR}")

  return(PROPAGATE CMAKE_C_FLAGS CMAKE_CXX_FLAGS CMAKE_EXE_LINKER_FLAGS CMAKE_SHARED_LINKER_FLAGS CMAKE_MODULE_LINKER_FLAGS)
endfunction()
